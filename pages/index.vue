<template>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
    ...
    <Trend color="red" title="Savings" :amount="4000" :last-amount="4500" :loading="pending" />
  </section>

  <section class="flex justify-between mb-10">
    <div>
      <h2 class="text-2xl font-extrabold">Transactions</h2>
      <div class="text-gray-500 dark:text-gray-400">You have {{ incomeCount }} incomes and {{ expenseCount }} expenses this period</div>
    </div>
    <div>
...
}} = useFetchTransactions(previous.value)
